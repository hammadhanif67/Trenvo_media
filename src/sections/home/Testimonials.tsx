          ...
          {hasTestimonials ? (
            <ul className="mt-12 grid gap-6 md:grid-cols-3">
              {TESTIMONIALS.map((t) => (
                <li
                  key={t.id}
                  className="flex h-full flex-col border border-hairline bg-base p-6"
                >
            ...
            <div className="mx-auto mt-12 max-w-[54ch] border border-hairline bg-base p-6 text-center">
